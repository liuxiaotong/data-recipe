...
| 角色 | 职责 | 人数 | 技能要求 |
|------|------|------|----------|
| **领域专家** | 构建 Context 内容 | 8-10 人 | 相关领域专业知识 |
| **任务设计师** | 设计 Task 和问题 | 4-6 人 | 教学设计/测试设计经验 |
| **Rubrics 编写员** | 编写验证标准 | 4-6 人 | 逻辑思维、细节导向 |
| **质检员** | 审核数据质量 | 2-3 人 | 数据质量控制经验 |
| **项目经理** | 协调进度 | 1 人 | 项目管理经验 |
...
3-4 个 Task (~4 小时/个)
    ↓
每 Task 15-20 条 Rubrics (~0.5 小时/条)
```
