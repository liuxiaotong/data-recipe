"""URL/paper-based analyzer for extracting dataset information via pattern matching.

Analyzes arXiv papers, dataset pages, and web URLs to extract dataset construction
methodology, size, quality methods, and generate production guides.
"""
