...
register_task_profile(TaskTypeProfile(
    type_id="preference",
    name="偏好对比数据",
...
register_task_profile(TaskTypeProfile(
    ...
    default_fields=[
        ...
        {"name": "answer", "type": "object", "required": True, "description": "答案",
         "properties": [
             {"name": "value", "type": "string", "required": True, "description": "标准答案"},
             {"name": "is_unique", "type": "boolean", "required": True, "description": "答案是否唯一"},
             {"name": "alternatives", "type": "array", "items": {"name": "alt", "type": "string"}, "description": "其他可接受答案"},
         ]},
        {"name": "explanation", "type": "string", "required": True, "description": "解题过程"},
        {"name": "scoring_rubric", "type": "object", "required": True, "description": "评分标准",
         "properties": [
             {"name": "full_score", "type": "string", "required": True, "description": "满分条件"},
             {"name": "partial_score", "type": "string", "description": "部分得分条件"},
             {"name": "zero_score", "type": "string", "required": True, "description": "零分条件"},
         ]},
    ],
    cost_multiplier=1.5,
